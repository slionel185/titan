...
export default function Navbar() {
    return (
        <div className='flex h-[10vh] max-h-[90px] justify-center items-center border-b px-4'>
            <div className='flex h-full w-full justify-center items-center max-w-7xl gap-4'>
                <NavSheet />
